...
public class LerasatiumBeadItem extends Item {
    public LerasatiumBeadItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (entity instanceof Player player && !level.isClientSide) {
            ...
            player.displayClientMessage(Component.translatable("message.mistborn_metal_arts.lerasatium_feruchemist"), true);
        }
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.mistborn_metal_arts.lerasatium").withStyle(ChatFormatting.GOLD));
    }
}

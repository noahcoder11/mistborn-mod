...
public final class ModCreativeTabs {
    private static final ResourceKey<Registry<CreativeModeTab>> CREATIVE_MODE_TAB_REGISTRY = ResourceKey
            .createRegistryKey(new ResourceLocation("minecraft", "creative_mode_tab"));

    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(CREATIVE_MODE_TAB_REGISTRY,
            MistbornMetalArts.MOD_ID);

    public static final RegistryObject<CreativeModeTab> METAL_ARTS = TABS.register("metal_arts",

...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> ATIUM_GEODE = BLOCKS.register("atium_geode", () -> new Block(BlockBehaviour.Properties.of().strength(4.0F, 8.0F).sound(SoundType.AMETHYST)));
    public static final RegistryObject<Block> BUDDING_ATIUM = BLOCKS.register("budding_atium", () -> new net.minecraft.world.level.block.BuddingAmethystBlock(BlockBehaviour.Properties.of().strength(4.0F, 8.0F).sound(SoundType.AMETHYST).randomTicks()));
    public static final RegistryObject<Block> ATIUM_CLUSTER = BLOCKS.register("atium_cluster", () -> new net.minecraft.world.level.block.AmethystClusterBlock(7, 3, BlockBehaviour.Properties.of().strength(2.0F).sound(SoundType.AMETHYST_CLUSTER).noOcclusion().lightLevel(state -> 5)));
